...
const ClientTypeAdd = () => {
  ...
  function postTypeClient(){
		dispatch(Actions.postTypeClient({
      "codigo_Tipo": cod,
      "nombre_Tipo":tipo
    }));
	}
    ...
    <>
      <CRow>
        <CCol xs="12" sm="12">
          <CCard>
            <CCardHeader>
            <span style={{fontWeight:'bold', lineHeight:'35px', fontSize:'20px'}}>Registrar nuevo tipo de cliente</span>
              {/* <DocsLink name="-Input"/> */}
            </CCardHeader>
            <CCardBody>
              <CRow>
            ...
            <CCardFooter>
              <CButton type="submit" size="sm" color="info" onClick={() => postTypeClient()}>Registrar</CButton>
            </CCardFooter>
          </CCard>
        </CCol>
      </CRow>
